...
export const SEVERITY_RANK: Record<PiiSeverity, number> = {
  critical: 3,
  high: 2,
  medium: 1,
  low: 0,
...
const PEM_KEY_UNTERMINATED: PiiPattern = {
...
const ANTHROPIC_API_KEY: PiiPattern = {
...
const OPENAI_API_KEY: PiiPattern = {
  name: 'openai-api-key',
...
const GENERIC_API_KEY: PiiPattern = {
...
const AWS_ACCESS_KEY: PiiPattern = {
...
const AWS_SECRET_ACCESS_KEY: PiiPattern = {
...
const UNDERSCORE_SECRET_KEY: PiiPattern = {
...
const URL_CREDENTIALS: PiiPattern = {
...
const ENV_SECRET_ASSIGNMENT: PiiPattern = {
...
const SECRET_ASSIGNMENT: PiiPattern = {
...
const CREDIT_CARD_LIKE: PiiPattern = {
...
const PASSPORT_NUMBER: PiiPattern = {
...
const ROUTING_OR_ACCOUNT_NUMBER: PiiPattern = {
...
const US_SSN_NO_SEPARATOR: PiiPattern = {
...
const EMAIL_PASSWORD_PROXIMITY: PiiPattern = {
...
const CLI_USERNAME_FLAG: PiiPattern = {
...
export const SENSITIVITY_HINTS: ReadonlyArray<PiiPattern> = PII_PATTERNS.filter(
